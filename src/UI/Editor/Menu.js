...
export const menuItems = (schema: MenuSchema): { fullMenu: MenuElement[] } => {
  let r = {},
    type
...
export type MenuSchema = typeof schema
...
export const menu = (options: MenuOptions): Menu =>
  menuBar({
    ...
    content: options.items ? options.items : menuItems(options.schema).fullMenu
  })
