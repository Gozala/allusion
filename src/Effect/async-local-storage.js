// Copied from https://github.com/domenic/async-local-storage/blob/73580d0151f04849ca9e691807907e95c4d17d12/prototype/implementation.mjs
...
function isDate(value) {
  try {
    ...
    // TODO: remove useless binding when that ships
    return false
  }
}
...
function throwForDisallowedKey(key) {
  if (!isAllowedAsAKey(key)) {
    throw new DOMException(
      "The given value is not allowed as a key",
      "DataError"
    )
  }
}
