...
import { nodePosition, resolvePosition } from "./Position.js"
import { EditNode } from "./Schema.js"
import { nodeBy } from "./Node.js"

/*::
import type { Transaction, Selection } from "../prosemirror-state/src/index.js"
import type {
  MarkType,
  ResolvedPos,
  Node,
...
const isInlineNodeContentMarkedWith = (
  node /* : Node */,
  mark /* : Mark */
) /* : boolean */ =>
  !node.isText && node.isInline && isFragmentMarkedWith(node.content, mark)

const isFragmentMarkedWith = (
  fragment /* : Fragment */,
  mark /* : Mark */
) /* : boolean */ => fragment.content.every(node => isMarkedWith(node, mark))
